...
import { Eye, EyeOff, Clock, Check, AlertCircle, DollarSign, ShoppingCart, Receipt, Phone, CreditCard, BarChart3, ArrowRight, User, Shield, Settings, HelpCircle, LogOut } from "lucide-react";
...
export default function PremiumDashboard() {
  ...
  // Premium Quick Actions with Custom SVG Icons
  const quickActions = [
    { icon: PremiumQRScannerSVG, label: "Scan & Pay", href: "/qr-scanner", gradient: "from-purple-500 to-pink-500" },
    { icon: PremiumSendMoneySVG, label: "Send Money", href: "/send-money", gradient: "from-blue-500 to-cyan-500" },
    { icon: PremiumSplitBillSVG, label: "Split Bill", href: "/split-bill", gradient: "from-green-500 to-emerald-500" },
    { icon: PremiumRequestMoneySVG, label: "Request", href: "/request", gradient: "from-orange-500 to-red-500" },
    { icon: PremiumRechargeSVG, label: "Recharge", href: "/recharge", gradient: "from-yellow-500 to-orange-500" },
    { icon: PremiumOfflinePaySVG, label: "Offline Pay", href: "/offline-payments", gradient: "from-indigo-500 to-purple-500" },
    { icon: PremiumInsuranceSVG, label: "Insurance", href: "/insurance", gradient: "from-teal-500 to-green-500" },
    { icon: PremiumRewardsSVG, label: "Rewards", href: "/rewards", gradient: "from-pink-500 to-rose-500" }
  ];
        ...
        <div className="glass-card p-6 mb-8 animate-slide-up-premium">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                <PremiumBellSVG className="h-6 w-6 text-foreground" />
              ...
              >
                <PremiumMenuSVG className="h-6 w-6 text-foreground" />
              </Button>
            </div>
          </div>
        </div>
            ...
            <div className="relative z-10 p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm motion-rich">
                    <PremiumDollarSVG className="h-7 w-7 text-white" />
                  </div>
                  <div>
              ...
              <div className="flex space-x-4">
                <Button className="flex-1 bg-white/20 hover:bg-white/30 text-white border-0 backdrop-blur-sm rounded-2xl motion-rich h-12 font-semibold">
                  <PremiumCreditCardSVG className="h-5 w-5 mr-2" />
                  Add Money
                </Button>
            ...
            return (
              <Link key={action.label} href={action.href}>
                <div className="quick-action-premium motion-rich glow-effect animate-scale-in-premium" style={{animationDelay: `${index * 0.1}s`}}>
                  <div className={`p-4 rounded-2xl bg-gradient-to-br ${action.gradient} mb-3 motion-rich flex items-center justify-center`}>
          ...
          <div className="absolute right-0 top-0 h-full w-80 glass-card animate-slide-up-premium">
            <div className="p-6">
              ...
              <div className="space-y-2">
                {[
                  { icon: PremiumUserSVG, label: "Profile", href: "/profile" },
                  { icon: PremiumCreditCardSVG, label: "Cards & Banks", href: "/cards" },
                  { icon: Shield, label: "Security", href: "/security" },
                  { icon: BarChart3, label: "Analytics", href: "/analytics" },
                  { icon: PremiumRewardsSVG, label: "Rewards", href: "/rewards" },
                  { icon: PremiumSettingsSVG, label: "Settings", href: "/settings" },
